        ...
        <div class="content col-md-12">
            ...
            <div class="detail">
                ...
                $output.='<div class="column" style="margin-left:35px; margin-top: 35px;">
                    ...
                    <input readonly value="'.$data['Expiration'].'" class="readonly">
                     <br>
                    <br>
                    <a class="button" href="account.php?lid='.$lid.'#addAccount" style="width:200px">Add to Account</a>
                </div>
                <div class="column" style="margin-left:100px; margin-top:35px;"> 

                    <label>Source</label>
                    <input readonly type="text" value="'.$data['Source'].'" class="readonly">
                    <br>
                    <label>Value</label>
                    <input readonly type="text" value="'.$data['Estimated_Value'].'" class="readonly">
                    <br>
                    <label>Owner</label>
            ...
            <div class="col-md-12 detail-2">
                <div class="col-md-6 detail-box">
                    ...
                    <div><a class="button" href="#quote" style="margin: -35px 0px 0px 360px; width: 120px">Send Quotation</a>
