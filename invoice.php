...
?>
    ...
    <?php //echo $cdata['Company_Name'] ?>
        <!--</div>-->
        <!--        <div>-->
        <?php //echo $datax['Telephone'] ?>
            <!--</div>-->
            <!--        <div>-->
            <?php //echo $cdata['Email']?>
                <!--</div>-->
                <!--    </div>-->
                <!--    <div id="project">-->
                ...
                <?php //echo $datax['Name'] ?>
                    ...
                    <?php //echo $cdata['Address'] ?>
                        <!--</div>-->
                        <!--        <div><span>EMAIL</span>-->
                        <?php //echo $datax['Email'] ?>
                            <!--</div>-->
                            <!--        <div><span>DATE</span>-->
                            <?php //$current_date = date('D d F Y');echo $current_date; ?>
                                <!--</div>-->
                                <!--    </div>-->
                                <!--</header>-->
                                <!--<main>-->
...
while($dataa=mysql_fetch_array($sqla)){
    $output.='<t?>
                                            <td class="service" style="text-align: left; vertical-align: top; padding: 20px;" align="left" valign="top">'.$i.'</td>
                                            ...
                                            '; $total = $total + $dataa['Value']; $i++; } $body = ''; $current_date = date('D d F Y'); $body.='
                                            <!DOCTYPE html>
                                            <html lang="en">
